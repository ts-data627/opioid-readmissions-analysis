...
**Takeaway:** Opioid prescribing rates alone don't explain readmission patterns in this data. Readmissions are more likely driven by condition-specific care gaps — particularly around hip/knee replacement follow-up — than by prescribing behavior.
...
- A simple regression model testing whether prescribing rate has any predictive power for readmission rate once other factors are controlled for
